...
def epipolar_mnn(
    ...
    for idx, pt in enumerate(kpt1):
        ...
        candidates1[idx] = {
            "kpt1": pt,
            "line": line,
            "kpt2_index": points_close_to_epi_line,
            "best_match": None,
        }
    ...
    for idx, pt in enumerate(kpt2):
        ...
        candidates2[idx] = {
            "kpt2": pt,
            "line": line,
            "kpt1_index": points_close_to_epi_line,
            "best_match": None,
        }
    ...
    for idx, _ in enumerate(kpt1):
        ...
        candidates1[idx]["best_match"] = candidates1[idx]["kpt2_index"][
            (desc1[idx] @ desc2[candidates1[idx]["kpt2_index"]].T).argmax()
        ].item()
    ...
    for idx, _ in enumerate(kpt2):
        ...
        candidates2[idx]["best_match"] = candidates2[idx]["kpt1_index"][
            (desc2[idx] @ desc1[candidates2[idx]["kpt1_index"]].T).argmax()
        ].item()
