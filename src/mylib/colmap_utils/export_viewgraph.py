...
def export_viewgraph(
    db_path: str,
    min_matches: int,
    db_name: str = "database.db",
    script="/home/mattia/Desktop/Repos/colmap/scripts/python/export_inlier_pairs.py",
):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Export viewgraph from COLMAP database"
    )
    parser.add_argument("--db_path", type=str, help="Path to the database")
    parser.add_argument(
        "--min_matches",
        type=int,
        help="Minimum number of matches to consider a pair of images",
    )
